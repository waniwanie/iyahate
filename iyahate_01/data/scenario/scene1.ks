...
[cm  ]
[layermode  mode="overlay"  color="0x263b2e"  time="1000"  wait="false"  ]
[bg  storage="IMG_20200730_144444757_.png"  time="1000"  ]
[tb_show_message_window  ]
[tb_start_text mode=1 ]
今よりも、少し住みづらくなった現世の話。[r]今よりも、奇怪な事件が増えた現世の話。[p]
とある地方の小さな寺院に、[r][p]
[_tb_end_text]

[tb_image_show  time="1000"  storage="default/3brooshadow.png"  width="903"  height="574"  x="3"  y="7"  _clickable_img=""  name="img_5"  ]
[tb_start_text mode=1 ]
3人の兄弟と、それに[ruby text="さぶら"]侍う獣たちがおったそうな。[p]
仲がいいとも悪いともいえぬ彼らは、[r]敬意よりも、むしろ畏怖の目で見られ、こう呼ばれていた。[p]
[wait time="500"][r][ruby text="いや"]弥[ruby text="はて"]終の一族と。[p]
...
[bg  time="0"  method="crossfade"  storage="AMEMAN17826012_TP_V_.png"  ]
[mask_off  time="1000"  effect="fadeOut"  ]
[tb_start_text mode=1 ]
人里、自然を残した水田の広がる風景。[r]そこで二人の子どもが遊んでいた。[r]のどかな風景であったが……。[p]
[_tb_end_text]
...
「わー！なんかいるぞ！捕まえてみよう！」[p]
#もうひとりの子ども
「なんだこれ、なんかゴキブリみたいなのがいる！」[p]
[_tb_end_text]

[quake  time="300"  count="3"  hmax="10"  wait="true"  ]
[tb_start_text mode=1 ]
#虫を捕まえた子ども
「わー、なんかキモい！なんだこれ！丸っこくて黒くてやっぱゴキブリじゃねえか？」[p]
#もうひとりの子ども
「いやそれじゃないよ！でもなんだろう、気になるなあ。」[p]
[_tb_end_text]

[tb_start_text mode=1 ]
#もうひとりの子ども
「あ！あそこにハゲのおじさんがいる！[r]あの人に聞いてみようよ！」[p]
#虫を捕まえた子ども
「ダメだよゆうた、知らないオッサンに話しかけたら[r]"怪異"にさらわれちゃうって言うだろ？」[p]
#ゆうたと呼ばれた子ども
「怪異なんて夜にしか出ないだろ？[r]だーいじょうぶ！それにあの人、子ども連れてるし、俺たちみて笑ってるし！」[p]
#虫を捕まえた子ども
「ったく、ゆうたは……。」[p]
[_tb_end_text]
